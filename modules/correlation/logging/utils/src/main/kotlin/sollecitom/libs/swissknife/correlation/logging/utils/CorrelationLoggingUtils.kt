...
suspend inline fun <ACCESS : Access, T> withLoggingContext(invocationContext: InvocationContext<ACCESS>, noinline convert: (InvocationContext<*>) -> String, crossinline action: suspend context(_: InvocationContext<*>) () -> T): T = withCoroutineLoggingContext(invocationContext.toLoggingContext(convert)) { action(invocationContext) }