...
fun JSONObject.getRequiredLong(field: String): Long = getLongOrNull(field) ?: error("Required JSON field '$field' is missing or not a Long")

fun JSONObject.getBigIntegerOrNull(field: String): BigInteger? = runCatching { getBigInteger(field) }.getOrNull()

fun JSONObject.getRequiredBigInteger(field: String): BigInteger = getBigIntegerOrNull(field) ?: error("Required JSON field '$field' is missing or not a BigInteger")

fun JSONObject.getBigDecimalOrNull(field: String): BigDecimal? = runCatching { getBigDecimal(field) }.getOrNull()

fun JSONObject.getRequiredBigDecimal(field: String): BigDecimal = getBigDecimalOrNull(field) ?: error("Required JSON field '$field' is missing or not a BigDecimal")
...
fun JSONObject.getRequiredDouble(field: String): Double = getDoubleOrNull(field) ?: error("Required JSON field '$field' is missing or not a Double")

fun JSONObject.getIntOrNull(field: String): Int? = runCatching { getInt(field) }.getOrNull()

fun JSONObject.getRequiredInt(field: String): Int = getIntOrNull(field) ?: error("Required JSON field '$field' is missing or not an Int")
...
fun JSONObject.getRequiredString(key: String): String = getStringOrNull(key) ?: error("Required JSON field '$key' is missing or not a String")

fun JSONObject.getBooleanOrNull(key: String): Boolean? = runCatching { getBoolean(key) }.getOrNull()
fun JSONObject.getRequiredBoolean(key: String): Boolean = getBooleanOrNull(key) ?: error("Required JSON field '$key' is missing or not a Boolean")

fun JSONObject.getRequiredJSONObject(key: String): JSONObject = getJSONObjectOrNull(key) ?: error("Required JSON field '$key' is missing or not a JSONObject")

fun JSONObject.getRequiredJSONArray(key: String): JSONArray = getArrayOrNull(key) ?: error("Required JSON field '$key' is missing or not a JSONArray")
...
fun JSONObject.getRequiredInstant(key: String) = getInstantOrNull(key) ?: error("Required JSON field '$key' is missing or not an Instant")

fun JSONObject.getStringArrayOrNull(key: String): List<String>? = getArrayOrNull(key)?.map { it.toString() }
fun JSONObject.getRequiredStringArray(key: String): List<String> = getStringArrayOrNull(key) ?: error("Required JSON field '$key' is missing or not a String array")

fun JSONObject.getIntArrayOrNull(key: String): List<Int>? = getArrayOrNull(key)?.map { (it as Number).toInt() }
fun JSONObject.getRequiredIntArray(key: String): List<Int> = getIntArrayOrNull(key) ?: error("Required JSON field '$key' is missing or not an Int array")
...
fun JSONObject.getBytesFromBase64String(key: String): ByteArray = getBytesFromBase64StringOrNull(key) ?: error("Required JSON field '$key' is missing or not a Base64 string")

fun JSONObject.getBytesFromHexStringOrNull(key: String): ByteArray? = getStringOrNull(key)?.let(HexFormat.of()::parseHex)
fun JSONObject.getBytesFromHexString(key: String): ByteArray = getBytesFromHexStringOrNull(key) ?: error("Required JSON field '$key' is missing or not a hex string")
